<h2><a href="https://practice.geeksforgeeks.org/problems/set-kth-bit3724/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Set kth bit</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong> and a value <strong>K</strong>. From the right, set the Kth bit in the binary representation of N. The position of Least Significant Bit(or last bit) is 0, the second last bit is 1 and so on.&nbsp;</span></p>
